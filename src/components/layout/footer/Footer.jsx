...
function Footer() {
    ...
    return (
        <>
            <footer className={`sticky bg-white dark:bg-gray-800 ${isLoggedIn ? 'xl:ml-64' : ''}`}>
                ...
                <div className="max-w-screen">
                    <div className="md:flex md:justify-between px-6">
                        <div className="mb-6 md:mb-0">
                            <NavLink to="https://flowbite.com" className="flex items-center">
                                ...
                                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">RJ</span>
                            </NavLink>
                        </div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between p-6">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <NavLink to="/" className="hover:underline">RJ™</NavLink>. All Rights Reserved.
                        </span>
